...
// Created: 8/10/2011 11:14:41 AM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsay0hycvz5bd4kzkvzlhgdu_5j1u";
	this.domain="statse.webtrendslive.com";
	this.timezone=0;
	this.fpcdom=".statistics.gov.uk";
	this.onsitedoms="www.ons.gov.uk";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,docx,xlsx,svg,exe,gif,jpg,jpeg,png";
	this.navigationtag="div,table";
	this.metanames="eGMS.disposalReview,DCTERMS.Issued";
