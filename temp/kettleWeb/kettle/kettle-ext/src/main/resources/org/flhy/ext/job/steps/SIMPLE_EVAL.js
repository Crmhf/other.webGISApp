SimpleEvalDialog = Ext.extend(KettleTabDialog,{
	...
	initComponent:function(){
		...
		var wFieldName = new Ext.form.TextField({fieldLabel:'字段名',anchor:'',flex:1,value:cell.getAttribute('fieldname')});
		...
		var wSuccessWhen = new Ext.form.Checkbox({fieldLabel:'Success when varible set',anchor:'-10',flex:1,checked:cell.getAttribute('insertScript')=='Y',
			listeners:{
		...
		this.tabItems =[
		                {
		        			...
		        			items:[{
		        				...
		        				title: '源',
		        				anchor: '-10',
		        				items:[wEvaluate,wFieldName,wFieldtype]
		        			},{
		        				xtype: 'fieldset',
		        				bodyStyle: 'padding: 10px 10px',
		        				title: '成功条件',
