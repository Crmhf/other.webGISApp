...
(function ($) {
    ...
    function _d8(_d9) {
        ...
        $(_d9).unbind().bind("mouseover", function (e) {
            ...
            e.preventDefault();//modify by ZWL 2015/12/31
            e.stopPropagation(); //modify by ZWL 2015/12/31
        });
    };
    function _e1(_e2) {
...
(function ($) {
    ...
    function _283(_284) {
        ...
        _285.window.draggable({
            handle: ">div.panel-header>div.panel-title", disabled: _285.options.draggable == false, onStartDrag: function (e) {
                if (_285.mask) {
        ...
        _285.window.resizable({
            disabled: _285.options.resizable == false, onStartResize: function (e) {
                if (_285.pmask) {
                    _285.pmask.remove();
                }
...
(function ($) {
    ...
    function _2a9(_2aa) {
        ...
        win.window($.extend({}, _2aa, {
            doSize: false, noheader: (_2aa.title ? false : true), onClose: function () {
                _2a5();
                if (_2aa.onClose) {
    ...
    $.messager = {
        show: function (_2ab) {
            ...
            var win = _2a9($.extend({}, $.messager.defaults, { content: "<div class=\"messager-progress\"><div class=\"messager-p-msg\">" + opts.msg + "</div><div class=\"messager-p-bar\"></div></div>", closable: false, doSize: false }, opts, {
                onClose: function () {
                    if (this.timer) {
...
(function ($) {
    ...
    function _2d4(_2d5, pp, _2d6) {
        ...
        pp.panel($.extend({}, { collapsible: true, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: true, headerCls: "accordion-header", bodyCls: "accordion-body" }, _2d6, {
            onBeforeExpand: function () {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, multiple: false, selected: 0, onSelect: function (_302, _303) {
...
(function ($) {
    ...
    function _325(_326) {
        ...
        if (tab) {
            ...
            /* start zzy 2015-12-11 */
            tab.parent().css("width", _329);
            tab.css("width", _329);
            /* end zzy 2015-12-11 */
        }
    };
    function _32b(_32c) {
        ...
        cc.bind("_resize", function (e, _32e) {
            if ($(this).hasClass("easyui-fluid") || _32e) {
                _319(_32c);
                _325(_32c);
                /*zzy 2015-11-13 start*/
                cc.find(".tabs-first").css("margin-left",
                cc.find(".tabs-scroller-left").css("display") == "block" ? "-1px" : "0px");
                cc.tabs("scrollBy", 0);
                /*zzy 2015-11-13 end*/
            }
            return false;
    ...
    function _33a(_33b, _33c, pp) {
        ...
        pp.panel($.extend({}, _33c, {
            tab: tab, border: false, noheader: true, closed: true, doSize: false, iconCls: (_33c.icon ? _33c.icon : undefined), onLoad: function () {
                if (_33c.onLoad) {
    ...
    function _346(_347, _348) {
        ...
        /*zzy 2015-11-13 start*/
        $(_347).find(".tabs-first").css("margin-left",
        $(_347).find(".tabs-scroller-left").css("display") == "block" ? "-1px" : "0px");
        /*zzy 2015-11-13 end*/
    };
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 27, selected: 0, showHeader: true, plain: false, fit: false, border: true, justified: false, narrow: false, pill: false, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_383) {
...
(function ($) {
    ...
    function _3a0(_3a1, _3a2, el) {
        ...
        _3a8.resizable($.extend({}, {
            handles: (_3a7[dir] || ""),
            /* start 2015-12-11 zzy */
            disabled: (!pp.panel("options").split) || (!pp.panel("options").resizable),
            /* end 2015-12-11 zzy */
    ...
    function _3b2(_3b3, _3b4, _3b5) {
        ...
        p.panel("panel").animate(_3bc.collapse, _3b5, function () {
            ...
            if (_3b6[_3b4].attr("Visible") == "false") _3b6[_3b8].panel("close");//zzy
            $(this).unbind(".layout");
            p.trigger('collapsed');
        });
        function _3b9(dir) {
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, { resizable: true, region: null, split: false, collapsedSize: 28, minWidth: 10, minHeight: 10, maxWidth: 10000, maxHeight: 10000 });
})(jQuery);
(function ($) {
    $(function () {
...
(function ($) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 26, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", onChange: function (_46f) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, validParams: null, delay: 200, missingMessage: "This field is required.", invalidMessage: null, tipPosition: "right", deltaX: 0, novalidate: false, events: {
            focus: _477, blur: _47b, mouseenter: _47f, mouseleave: _482, click: function (e) {
                var t = $(e.data.target);
                if (!t.is(":focus")) {
                    t.trigger("focus");
                }
...
(function ($) {
    ...
    function _4bd(_4be) {
        ...
        _4bf.validatebox($.extend({}, opts, {
            deltaX: $(_4be).textbox("getTipX"), onBeforeValidate: function () {
                var box = $(this);
                if (!box.is(":focus")) {
...
(function ($) {
    ...
    function load(_50f, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _510, dataType: "json", success: function (data) {
                    _511(data);
                }, error: function () {
    ...
    $.fn.form.defaults = {
        fieldTypes: ["combobox", "combotree", "combogrid", "datetimebox", "datebox", "combo", "datetimespinner", "timespinner", "numberspinner", "spinner", "slider", "searchbox", "numberbox", "textbox", "switchbutton"], novalidate: false, ajax: true, url: null, queryParams: {}, onSubmit: function (_52f) {
...
(function ($) {
    ...
    function _600(_601) {
        ...
        _603.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_604, _605) {
        ...
        if (opts.pagination) {
            ...
            _608.pagination({
                total: (opts.pageNumber * opts.pageSize), pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_609, _60a) {
    ...
    function _615(_616) {
        ...
        _61a.each(function () {
            $(this).resizable({
                handles: _61d, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _617.resizing = true;
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowEvents: { mouseover: _621(true), mouseout: _621(false), click: _629, dblclick: _633, contextmenu: _637 }, rowStyler: function (_7c3, _7c4) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _7c5, dataType: "json", success: function (data) {
                    _7c6(data);
                }, error: function () {
...
(function ($) {
    ...
    function _7ff(_800) {
        ...
        $(_800).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_802, row) {
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        singleSelect: true, remoteSort: false, fitColumns: true, loadMsg: "", frozenColumns: [[{ field: "f", width: 16, resizable: false }]], columns: [[{ field: "name", title: "Name", width: 100, sortable: true }, { field: "value", title: "Value", width: 100, resizable: false }]], showGroup: false, groupView: _80e, groupField: "group", groupFormatter: function (_84b, rows) {
            return _84b;
        }
    });
})(jQuery);
(function ($) {
    function _84c(_84d) {
        ...
        if (opts.pagination) {
            ...
            _859.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_85a, _85b) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, lines: false, animate: false, singleSelect: true, view: _8d6, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _867(true), mouseout: _867(false), click: _869 }), loader: function (_913, _914, _915) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _913, dataType: "json", success: function (data) {
                    _914(data);
                }, error: function () {
...
(function ($) {
    function _91f(_920) {
        ...
        $(_920).datagrid($.extend({}, opts, {
            cls: "datalist" + (opts.lines ? " datalist-lines" : ""), frozenColumns: (opts.frozenColumns && opts.frozenColumns.length) ? opts.frozenColumns : (opts.checkbox ? [[{ field: "_ck", checkbox: true }]] : undefined), columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_921, row, _922) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _923, textFormatter: function (_93f, row) {
            return _93f;
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupField: null, groupFormatter: function (_9c8) {
            return _9c8;
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _9c9, dataType: "json", success: function (data) {
                    _9ca(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_aae) {
            return _aae;
        }, converter: {
