(function(factory) {
    ...
    providers['OpenStreetMap_Mapnik'] = {
        title: 'osm',
        icon: 'config/icons/openstreetmap_mapnik.png',
    ...
    providers['OpenStreetMap_BlackAndWhite'] = {
        title: 'osm bw',
        icon: 'config/icons/openstreetmap_blackandwhite.png',
    ...
    providers['OpenStreetMap_DE'] = {
        title: 'osm de',
        icon: 'config/icons/openstreetmap_de.png',
    ...
    providers['Stamen_Toner'] = {
        title: 'toner',
        icon: 'config/icons/stamen_toner.png',
    ...
    providers['Esri_OceanBasemap'] = {
        title: 'esri ocean',
        icon: 'config/icons/esri_oceanbasemap.png',
    ...
    providers['HERE_normalDay'] = {
        title: 'normalday',
        icon: 'config/icons/here_normalday.png',
    ...
    providers['HERE_normalDayGrey'] = {
        ...
        icon: 'config/icons/here_normaldaygrey.png',
    ...
    providers['HERE_satelliteDay'] = {
        title: 'satellite',
        icon: 'config/icons/here_satelliteday.png',
    ...
    providers['CartoDB_Positron'] = {
        title: 'positron',
        icon: 'config/icons/cartodb_positron.png',
