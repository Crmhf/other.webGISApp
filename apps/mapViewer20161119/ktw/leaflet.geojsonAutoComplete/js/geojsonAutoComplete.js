(function ($) {
    ...
    var options = {
        ...
        placeholderMessage: "搜索...",
        searchButtonTitle: "Search",
        clearButtonTitle: "Clear",
        foundRecordsMessage: "显示结果记录.",
        limit: 10,
    ...
    function createDropDown(withPaging) {
        ...
        for (var i = 0; i < loopCount; i++) {
            ...
            html += "<span id='listElementContent" + i + "' class='content'><img src='./data/img/" + features[i].properties.image + "' class='iconStyle' align='middle'>";
