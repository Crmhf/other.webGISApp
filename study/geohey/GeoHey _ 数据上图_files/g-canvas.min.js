...
e=f.zoomReses[b],k=f.tileSize,l=a.getDrawSize(),m=1+2*a.options.canvasExpandFactor,q=l[0]*m,l=l[1]*m,e=[d[0]-q*e/2,d[1]-l*e/2,d[0]+q*e/2,d[1]+l*e/2],a=a.options.maxExtent,n,p;this._redrawExtent=e;var e=G.ExtentUtil.intersect(e,a),s;for(s in this._tiles)m=this._tiles[s],a=m._info,n=a[0],q=a[1],p=a[2],l=f.zoomReses[p],p!==b&&(this._stopLoadingTile(m),(!f.keepResample||1>f.opacity)&&this._removeTile(s)),m=f.originX+n*k*l,n=f.originX+(n+1)*k*l,p=f.originY-(q+1)*k*l,q=f.originY-q*k*l,(q=G.ExtentUtil.overlaps([m,
p,n,q],e))||this._tileInfoExist(a,c)||this._removeTile(s);b=this._calcTileIndex(d[0],d[1],b);this._sortTileInfos(c,b[0],b[1]);this._addTiles(c);this._draw()}},_draw:function(){var a=this._map,b=this.options,a=this._ctx=a._useOffScreen?a._offScreenCtx:a._onScreenCtx,c,d,f,e,k=this._zoom,l,m=1>b.opacity;m&&(a.save(),a.globalAlpha=b.opacity);for(l in this._tiles)c=this._tiles[l],d=c._info,e=parseInt(d[2]),!c._loaded||(e===k||!b.keepResample||1>b.opacity)||(f=parseInt(d[0]),d=parseInt(d[1]),this._placeTile(c,
f,d,e));for(l in this._tiles)c=this._tiles[l],d=c._info,e=parseInt(d[2]),c._loaded&&e===k&&(f=parseInt(d[0]),d=parseInt(d[1]),this._placeTile(c,f,d,e));m&&a.restore()},_placeTile:function(a,b,c,d){if(a._loaded){var f=Math.round,e=G.MathUtil,k=G.Browser.getPxRatio(),l=k[0],k=k[1],m=this._map,q=m._rotate,n=this.options,p=m.options,s=n.tileSize,r=s*n.zoomReses[d];d=n.tileEnlarge&&(!!(q%90)||G.Browser.gecko||G.Browser.safari);var t=Math.ceil(r/m._res)+(d?2:0);b=n.originX+b*r;c=n.originY-c*r;var r=this._zoomScale||
this._scale,v=this._aroundScreen;r&&1!==r&&(t/=r);if(!(t>4*(s+2)||t<s/8)){var u=s=0,x=p.maxExtent,y=x[2]-x[0];p.wrap&&(p=this._redrawExtent)&&x&&(u=Math.floor((p[0]-n.minX)/y)-1,s=Math.ceil((p[2]-n.maxX)/y)+1);for(n=u;n<=s;n++){u=m.toScreen([b+n*y,c],v,r);p=u[0];u=u[1];x=m._canvasOffset;p+=x[0];u+=x[1];d&&(p-=1,u-=1);p=f(p);u=f(u);x=this._ctx;q&&(x.save(),x.translate(p,u),x.rotate(q/e.DEGREE_PER_RADIAN),x.translate(-p,-u));try{x.drawImage(a,p,u,f(t/l),f(t/k))}catch(z){}q&&x.restore()}}}},_addTiles:function(a){if(0!==
a.length){this._numLoad=a.length;this._numLoadError=this._numLoadSuccess=0;for(var b=this.options,c,d,f,e,k,l=this.options.errorTileUrl||G.Layer.Tile.EMPTY_TILE,m=0,q=a.length;m<q;m++)c=a[m],d=c[0],f=c[1],e=c[2],k=this._getTileName(d,f,e),(c=this._tiles[k])?c.src==l?+new Date-c._responseTime>b.tileLiveMs&&this._loadTile(c,d,f,e):this._numLoadSuccess++:(c=this._getIdleTile(),this._tiles[k]=c,this._loadTile(c,d,f,e));this._checkAllHandled()}},_clearBgBuffer:function(){var a,b;for(b in this._tiles)a=
...
d&&a.restore()},_placeImage:function(a){if(a._loaded){var b=G.MathUtil,c=G.Browser.getPxRatio(),d=c[0],c=c[1],f=this._map,e=f._res,k=f._rotate,l=a.bbox,m=l[0],q=l[1],n=this._zoomScale||this._scale,p=this._aroundScreen,s=(l[2]-l[0])/e,e=(l[3]-l[1])/e;n&&1!==n&&(s/=n,e/=n);q=f.toScreen([m,q],p,n);m=q[0];q=q[1];f=f._canvasOffset;m+=f[0];q+=f[1];f=this._ctx;k&&(f.save(),f.translate(m,q),f.rotate(k/b.DEGREE_PER_RADIAN),f.translate(-m,-q));try{f.drawImage(a,m,q-e/c,s/d,e/c)}catch(r){}k&&f.restore()}},_onZoomStart:function(){},
...
G.Layer.GeoHeyFeature=G.Layer.FeatureService.extend({options:{apiKey:"",where:"1=1",outFields:"",limit:1E3},init:function(a,b){var c=this;G.Layer.FeatureService.prototype.init.call(c,function(b){var f=a+"/query",e=c.options,k={ak:e.apiKey,where:e.where,outFields:e.outFields,limit:e.limit};b&&(k.geometry=JSON.stringify(b));k={responseType:"http"===f.slice(0,4).toLowerCase()?"JSONP":"JSON",data:k,success:function(a,f){var k=f.data,n=k.geometryType;if(k=k.features){var p;p=k.length-1;for(var s=Math.max(0,
p-e.limit),r,t,v,u=[],x;p>=s;p--)for(x in r=k[p],t=r.id,v=r.geom,r=r.attrs||{},"Point"==n?u.push(new G.Graphic.Point(v,r)):"Polyline"==n?u.push(new G.Graphic.Polyline(v,r)):"Polygon"==n?u.push(new G.Graphic.Polygon(v,r)):"MultiPoint"==n?u.push(new G.Graphic.MultiPoint(v,r)):"MultiPolyline"==n?u.push(new G.Graphic.MultiPolyline(v,r)):"MultiPolygon"==n&&u.push(new G.Graphic.MultiPolygon(v,r)),u)if(r=u[x])v=t+"_"+x,c.get(v)||r.addTo(c,v)}c.onSuccess(b)},error:function(){c.onError(b)},complete:function(){c.onComplete(b)}};
G.Util.ajax(f,k)},b)}});
...
d){b._processResult(a,d)},complete:function(){b._req=null}};b._req=G.Util.ajax(k,c)},_processResult:function(a,b){var c=this.options,d=this._loadRes,f=this._loadExtent,e=c.tolerance*Math.pow(c.stepFactor,c.stepCount-a),e=d*e,k=b.geometryType,l=b.features;if(l){var m,q,n,p,s,r;for(m=l.length-1;0<=m;m--)if(q=l[m],n=q.id,p=q.geom,q=q.attrs||{},"Point"==k)r=new G.Graphic.Point(p,q),this._updateGraphic(e,n,0,r);else if("Polyline"==k)r=new G.Graphic.Polyline(p,q),this._updateGraphic(e,n,0,r);else if("Polygon"==
k)r=new G.Graphic.Polygon(p,q),this._updateGraphic(e,n,0,r);else if("MultiPoint"==k)for(s in p.multi)r=p.multi[s],r=new G.Graphic.Point(r,q),this._updateGraphic(e,n,s,r);else if("MultiPolyline"==k)for(s in p.multi)r=p.multi[s],r=new G.Graphic.Polyline(r,q),this._updateGraphic(e,n,s,r);else if("MultiPolygon"==k)for(s in p.multi)r=p.multi[s],r=new G.Graphic.Polygon(r,q),this._updateGraphic(e,n,s,r);a<c.stepCount?this._loadStep(a+1):(this._clearDirty(),this._loadedStatus=[d,f],this.onSuccess(f),this.onComplete(f))}else this.onError(f),
...
"g-clickable")}});
G.Graphic.Polygon=G.Graphic.Polygon.extend({_onAdded:function(){var a=this._layer._map;a&&a._requestRedraw()},_onRemoved:function(){var a=this._layer._map;a&&a._requestRedraw()},_draw:function(){var a=this.options,b=this._layer,c=b._map,b=b._ctx,d=this.geom,f,e,k,l=c._canvasOffset,m=this.bbox,m=c._calcWrapPointRange([(m[0]+m[2])/2,(m[1]+m[3])/2])||[0,0],q=c.options.maxExtent,q=q[2]-q[0];b.save();for(var n=m[0];n<=m[1];n++){b.beginPath();for(var p=0,s=d.length;p<s;p++){e=d[p];for(var r=0,t=e.length;r<
t;r++)k=e[r],k=c.toScreen([k[0]+n*q,k[1]]),f=0===r?"moveTo":"lineTo",b[f](k[0]+l[0],k[1]+l[1]);k=e[0];k=c.toScreen([k[0]+n*q,k[1]]);b.lineTo(k[0]+l[0],k[1]+l[1])}a.fill&&(a.fillImage?(f=G.Browser.getImageSrc(a.fillImage),f=G.DomUtil.getImgElement(f,function(){c._requestRedraw()},null,"*"),f._loaded?(b.fillStyle=b.createPattern(f,"repeat"),b.globalAlpha=a.fillOpacity):b.globalAlpha=0):(b.fillStyle=a.fillColor,b.globalAlpha=a.fillOpacity),b.fill());if(a.outline||this._mouseOver||this._editing)b.strokeStyle=
...
b.beginPath();for(var q=l[0];q<=l[1];q++)for(var n=0,p=c.length;n<p;n++){f=c[n];for(var s=0,r=f.length;s<r;s++)e=f[s],e=a.toScreen([e[0]+q*m,e[1]]),d=0===s?"moveTo":"lineTo",b[d](e[0]+k[0],e[1]+k[1]);e=f[0];e=a.toScreen([e[0]+q*m,e[1]]);b.lineTo(e[0]+k[0],e[1]+k[1])}b.fill()},_onStartEdit:function(){var a=this._layer._map,b=this.virtualMouse;for(i in b.DOWN)a.addListener(b.DOWN[i],this._onVertexDragStart,this);this._refreshVertexes()},_onEndEdit:function(){var a=this._layer._map,b=this.virtualMouse,
c,d;for(c in b.DOWN)d=b.DOWN[c],a.removeListener(d,this._onVertexDragStart,this),a.removeListener(b.MOVE[d],this._onVertexDrag,this),a.removeListener(b.UP[d],this._onVertexDragEnd,this);this._removeVertexes();G.DomUtil.removeClass(a._layersFrame,"g-edit");a._requestRedraw()},_onMouseOver:function(){var a=this._layer._map;a._requestRedraw();G.DomUtil.addClass(a._layersFrame,"g-clickable")},_onMouseOut:function(){var a=this._layer._map;a._requestRedraw();G.DomUtil.removeClass(a._layersFrame,"g-clickable")}});
G.Graphic.MultiPoint=G.Graphic.MultiPoint.extend({_onAdded:function(){var a=this._layer._map;a&&a._requestRedraw()},_onRemoved:function(){var a=this._layer._map;a&&a._requestRedraw()},_draw:function(){var a=this.options,b=this._layer,c=b._map,b=b._ctx,d=Math.round,f=a.shape,e=a.size,k=e[0],e=e[1],l=a.offset,m=a.imageRotate;a.imageGravity||(m+=c._rotate);"image"==f&&m&&(l=G.MathUtil.rotateVector(l,m));var q=this.geom.m,n,p,s=c._canvasOffset,r=this.bbox,r=c._calcWrapPointRange([(r[0]+r[2])/2,(r[1]+
r[3])/2])||[0,0];p=c.options.maxExtent;for(var t=p[2]-p[0],v=r[0];v<=r[1];v++)for(var u=0;u<q.length;u++)if(n=q[u],n=c.toScreen([n[0]+v*t,n[1]]),p=n[0]+l[0]+s[0],n=n[1]+l[1]+s[1],"rect"==f)b.beginPath(),b.rect(p-k/2,n-e/2,k,e),this._renderPath(p,n,Math.max(k/2,e/2));else if("image"==f){var x=G.Browser.getImageSrc(a.image),x=G.DomUtil.getImgElement(x,function(){c._requestRedraw()});x._loaded&&(b.save(),b.translate(d(p),d(n)),b.rotate(m/G.MathUtil.DEGREE_PER_RADIAN),b.drawImage(x,0,0,k,e),b.restore())}else"text"==
f?(b.save(),b.fillStyle=a.fillColor,b.globalAlpha=a.fillOpacity,b.font=a.textStyle+" "+k+"px "+a.textFont,b.textAlign=a.textAlign,b.textBaseline="middle",x=a.text,this._textMeasureWidth&&this._textMeasure==x||(this._textMeasureWidth=b.measureText(x).width,this._textMeasure=x),b.fillText(x,p,n),b.restore()):(b.beginPath(),b.arc(p,n,k/2,0,2*Math.PI),this._renderPath(p,n,k/2))},_renderPath:function(a,b,c){var d=this._layer,f=d._map,d=d._ctx,e=this.options;d.save();e.fill&&(e.fillImage?(a=G.Browser.getimgSrc(e.fillImage),
a=G.DomUtil.getImgElement(a,function(){f._requestRedraw()}),a._loaded?(d.fillStyle=d.createPattern(a,"repeat"),d.globalAlpha=e.fillOpacity):d.globalAlpha=0):e.gradual?(a=d.createRadialGradient(a,b,0,a,b,c),b=G.Util.colorRgb(e.fillColor),a.addColorStop(0,e.fillColor),a.addColorStop(1,"rgba("+b[0]+","+b[1]+","+b[2]+","+e.fillOpacity+")"),d.fillStyle=a):(d.fillStyle=e.fillColor,d.globalAlpha=e.fillOpacity),d.fill());if(e.outline||this._mouseOver||this._editing)d.strokeStyle=this._editing?e.lineHighlightColor:
e.outline?e.outlineColor:e.fillColor,d.lineWidth=this._mouseOver?e.outlineWidth+e.lineHighlightWiden:e.outlineWidth,d.globalAlpha=e.outlineOpacity,G.Util.setCanvasLineDash(d,e.outlineDashArray),d.stroke();d.restore()},_onStartEdit:function(){var a=this._layer._map,b=this.virtualMouse,c;for(c in b.DOWN)a.addListener(b.DOWN[c],this._onVertexDragStart,this);this._refreshVertexes()},_onEndEdit:function(){var a=this._layer._map,b=this.virtualMouse,c;for(c in b.DOWN)a.removeListener(b.DOWN[c],this._onVertexDragStart,
this);this._removeVertexes()},_onMouseOver:function(){var a=this._layer;if(a){var a=a._map,b=G.DomUtil;a._requestRedraw();this._isVertex?b.addClass(a._layersFrame,"g-edit"):b.addClass(a._layersFrame,"g-clickable")}},_onMouseOut:function(){var a=this._layer;if(a){var a=a._map,b=G.DomUtil;a._requestRedraw();this._isVertex?b.removeClass(a._layersFrame,"g-edit"):b.removeClass(a._layersFrame,"g-clickable")}}});
G.Graphic.MultiPolyline=G.Graphic.MultiPolyline.extend({_onAdded:function(){var a=this._layer._map;a&&a._requestRedraw()},_onRemoved:function(){var a=this._layer._map;a&&a._requestRedraw()},_draw:function(){var a=this.options,b=this._layer,c=b._map,b=b._ctx,d=this.geom.m,f,e,k,l=c._canvasOffset,m=this.bbox,m=c._calcWrapPointRange([(m[0]+m[2])/2,(m[1]+m[3])/2])||[0,0];f=c.options.maxExtent;var q=f[2]-f[0];b.save();b.beginPath();for(var n=m[0];n<=m[1];n++)for(var p=0,s=d.length;p<s;p++){f=d[p];for(var r=
0,t=f.length;r<t;r++)k=f[r],k=c.toScreen([k[0]+n*q,k[1]]),e=0===r?"moveTo":"lineTo",b[e](k[0]+l[0],k[1]+l[1])}b.strokeStyle=this._editing?a.lineHighlightColor:a.lineColor;b.lineCap=a.lineCap;b.lineJoin=a.lineJoin;b.lineWidth=this._mouseOver?a.lineWidth+a.lineHighlightWiden:a.lineWidth;b.globalAlpha=a.lineOpacity;G.Util.setCanvasLineDash(b,a.lineDashArray);b.stroke();b.restore()},_onStartEdit:function(){var a=this._layer._map,b=this.virtualMouse;for(i in b.DOWN)a.addListener(b.DOWN[i],this._onVertexDragStart,
this);this._refreshVertexes()},_onEndEdit:function(){var a=this._layer._map,b=this.virtualMouse,c,d;for(c in b.DOWN)d=b.DOWN[c],a.removeListener(d,this._onVertexDragStart,this),a.removeListener(b.MOVE[d],this._onVertexDrag,this),a.removeListener(b.UP[d],this._onVertexDragEnd,this);this._removeVertexes();G.DomUtil.removeClass(a._layersFrame,"g-edit");a._requestRedraw()},_onMouseOver:function(){var a=this._layer._map;a._requestRedraw();G.DomUtil.addClass(a._layersFrame,"g-clickable")},_onMouseOut:function(){var a=
this._layer._map;a._requestRedraw();G.DomUtil.removeClass(a._layersFrame,"g-clickable")}});
G.Graphic.MultiPolygon=G.Graphic.MultiPolygon.extend({_onAdded:function(){var a=this._layer._map;a&&a._requestRedraw()},_onRemoved:function(){var a=this._layer._map;a&&a._requestRedraw()},_draw:function(){var a=this.options,b=this._layer,c=b._map,b=b._ctx,d=this.geom.m,f,e,k,l,m=c._canvasOffset,q=this.bbox,q=c._calcWrapPointRange([(q[0]+q[2])/2,(q[1]+q[3])/2])||[0,0];f=c.options.maxExtent;var n=f[2]-f[0];b.save();b.beginPath();for(var p=q[0];p<=q[1];p++)for(var s=0,r=d.length;s<r;s++){f=d[s];for(var t=
0,v=f.length;t<v;t++){k=f[t];for(var u=0,x=k.length;u<x;u++)l=k[u],l=c.toScreen([l[0]+p*n,l[1]]),e=0===u?"moveTo":"lineTo",b[e](l[0]+m[0],l[1]+m[1]);l=k[0];l=c.toScreen([l[0]+p*n,l[1]]);b.lineTo(l[0]+m[0],l[1]+m[1])}}a.fill&&(a.fillImage?(d=G.Browser.getImageSrc(a.fillImage),d=G.DomUtil.getImgElement(d,function(){c._requestRedraw()},null,"*"),d._loaded?(b.fillStyle=b.createPattern(d,"repeat"),b.globalAlpha=a.fillOpacity):b.globalAlpha=0):(b.fillStyle=a.fillColor,b.globalAlpha=a.fillOpacity),b.fill());
if(a.outline||this._mouseOver||this._editing)b.strokeStyle=this._editing?a.lineHighlightColor:a.outline?a.outlineColor:a.fillColor,b.lineCap=a.outlineCap,b.lineJoin=a.outlineJoin,b.lineWidth=(a.outline?a.outlineWidth:0)+(this._mouseOver?a.lineHighlightWiden:0),b.globalAlpha=a.outlineOpacity,G.Util.setCanvasLineDash(b,a.outlineDashArray),b.stroke();b.restore()},_drawMask:function(){var a=this._map,b=a._maskCtx,c=this.geom.m,d,f,e,k,l=a._canvasOffset,m=this.bbox,m=a._calcWrapPointRange([(m[0]+m[2])/
2,(m[1]+m[3])/2])||[0,0];d=a.options.maxExtent;var q=d[2]-d[0];b.beginPath();for(var n=m[0];n<=m[1];n++)for(var p=0,s=c.length;p<s;p++){d=c[p];for(var r=0,t=d.length;r<t;r++){e=d[r];for(var v=0,u=e.length;v<u;v++)k=e[v],k=a.toScreen([k[0]+n*q,k[1]]),f=0===v?"moveTo":"lineTo",b[f](k[0]+l[0],k[1]+l[1]);k=e[0];k=a.toScreen([k[0]+n*q,k[1]]);b.lineTo(k[0]+l[0],k[1]+l[1])}}b.fill()},_onStartEdit:function(){var a=this._layer._map,b=this.virtualMouse;for(i in b.DOWN)a.addListener(b.DOWN[i],this._onVertexDragStart,
this);this._refreshVertexes()},_onEndEdit:function(){var a=this._layer._map,b=this.virtualMouse,c,d;for(c in b.DOWN)d=b.DOWN[c],a.removeListener(d,this._onVertexDragStart,this),a.removeListener(b.MOVE[d],this._onVertexDrag,this),a.removeListener(b.UP[d],this._onVertexDragEnd,this);this._removeVertexes();G.DomUtil.removeClass(a._layersFrame,"g-edit");a._requestRedraw()},_onMouseOver:function(){var a=this._layer._map;a._requestRedraw();G.DomUtil.addClass(a._layersFrame,"g-clickable")},_onMouseOut:function(){var a=
this._layer._map;a._requestRedraw();G.DomUtil.removeClass(a._layersFrame,"g-clickable")}});
G.Graphic.Circle=G.Graphic.Circle.extend({_onAdded:function(){var a=this._layer._map;a&&a._requestRedraw()},_onRemoved:function(){var a=this._layer._map;a&&a._requestRedraw()},_draw:function(){var a=this.options,b=this._layer,c=b._map,b=b._ctx,d=this.geom,f=d[0],e=d[1],k=d[2]/c._res,l=c._canvasOffset,d=c._calcWrapPointRange(d)||[0,0],m=c.options.maxExtent,m=m[2]-m[0];b.save();for(var q=d[0];q<=d[1];q++){var n=c.toScreen([f+q*m,e]);n[0]+=l[0];n[1]+=l[1];b.beginPath();b.arc(n[0],n[1],k,0,2*Math.PI);
if(a.fill){if(a.fillImage)n=G.Browser.getImageSrc(a.fillImage),n=G.DomUtil.getImgElement(n,function(){c._requestRedraw()},null,"*"),n._loaded?(b.fillStyle=b.createPattern(n,"repeat"),b.globalAlpha=a.fillOpacity):b.globalAlpha=0;else if(a.gradual){var n=b.createRadialGradient(n[0],n[1],0,n[0],n[1],k),p=G.Util.colorRgb(a.fillColor);n.addColorStop(0,a.fillColor);n.addColorStop(1,"rgba("+p[0]+","+p[1]+","+p[2]+","+a.fillOpacity+")");b.fillStyle=n}else b.fillStyle=a.fillColor,b.globalAlpha=a.fillOpacity;
b.fill()}if(a.outline||this._mouseOver)b.strokeStyle=this._editing?a.lineHighlightColor:a.outlineColor,b.lineWidth=this._mouseOver?a.outlineWidth+a.lineHighlightWiden:a.outlineWidth,b.globalAlpha=a.outlineOpacity,G.Util.setCanvasLineDash(b,a.outlineDashArray),b.stroke()}b.restore()},_drawMask:function(){var a=this._map,b=a._maskCtx,c=this.geom,d=c[0],f=c[1],e=c[2]/a._res,k=a._canvasOffset,c=a._calcWrapPointRange(c)||[0,0],l=a.options.maxExtent,l=l[2]-l[0];b.beginPath();for(var m=c[0];m<=c[1];m++){var q=
a.toScreen([d+m*l,f]);q[0]+=k[0];q[1]+=k[1];b.arc(q[0],q[1],e,0,2*Math.PI,!1)}b.fill()},_onStartEdit:function(){var a=this._layer._map,b=this.virtualMouse,c;for(c in b.DOWN)a.addListener(b.DOWN[c],this._onVertexDragStart,this);this._refreshVertexes()},_onEndEdit:function(){var a=this._layer._map,b=this.virtualMouse,c;for(c in b.DOWN)a.removeListener(b.DOWN[c],this._onVertexDragStart,this);this._removeVertexes()},_onMouseOver:function(){var a=this._layer._map;a._requestRedraw();G.DomUtil.addClass(a._layersFrame,
"g-clickable")},_onMouseOut:function(){var a=this._layer._map;a._requestRedraw();G.DomUtil.removeClass(a._layersFrame,"g-clickable")}});
G.Graphic.Arrow=G.Graphic.Arrow.extend({_draw:function(){var a=this.options,b=this._layer,c=b._map,b=b._ctx;this._updateGeomDraw(c._res);var d=this._geomDraw,f,e,k,l=c._canvasOffset,m=this.bbox,m=c._calcWrapPointRange([(m[0]+m[2])/2,(m[1]+m[3])/2])||[0,0],q=c.options.maxExtent,q=q[2]-q[0];b.save();for(var n=m[0];n<=m[1];n++){b.beginPath();for(var p=0,s=d.length;p<s;p++){e=d[p];for(var r=0,t=e.length;r<t;r++)k=e[r],k=c.toScreen([k[0]+n*q,k[1]]),f=0===r?"moveTo":"lineTo",b[f](k[0]+l[0],k[1]+l[1]);k=
e[0];k=c.toScreen([k[0]+n*q,k[1]]);b.lineTo(k[0]+l[0],k[1]+l[1])}a.fill&&(a.fillImage?(f=G.Browser.getImageSrc(a.fillImage),f=G.DomUtil.getImgElement(f,function(){c._requestRedraw()},null,"*"),f._loaded?(b.fillStyle=b.createPattern(f,"repeat"),b.globalAlpha=a.fillOpacity):b.globalAlpha=0):(b.fillStyle=a.fillColor,b.globalAlpha=a.fillOpacity),b.fill());if(a.outline||this._mouseOver||this._editing)b.strokeStyle=this._editing?a.lineHighlightColor:a.outline?a.outlineColor:a.fillColor,b.lineCap=a.outlineCap,
b.lineJoin=a.outlineJoin,b.lineWidth=(a.outline?a.outlineWidth:0)+(this._mouseOver?a.lineHighlightWiden:0),b.globalAlpha=a.outlineOpacity,G.Util.setCanvasLineDash(b,a.outlineDashArray),b.stroke()}b.restore()},_drawMask:function(){var a=this._map,b=a._maskCtx;this._updateGeomDraw(a._res);var c=this._geomDraw,d,f,e,k=a._canvasOffset,l=this.bbox,l=a._calcWrapPointRange([(l[0]+l[2])/2,(l[1]+l[3])/2])||[0,0];d=a.options.maxExtent;var m=d[2]-d[0];b.beginPath();for(var q=l[0];q<=l[1];q++)for(var n=0,p=c.length;n<
...
G.Graphic.Group=G.Graphic.Group.extend({_onMouseOver:function(){var a=this._layer._map;a._requestRedraw();G.DomUtil.addClass(a._layersFrame,"g-clickable")},_onMouseOut:function(){var a=this._layer._map;a._requestRedraw();G.DomUtil.removeClass(a._layersFrame,"g-clickable")}});
...
1);h=b.height/(ratio[1]||1);try{this._clearCanvas(this._onScreenCtx),this._onScreenCtx.drawImage(this._offScreenCtx.canvas,0,0,w,h)}catch(k){}}try{this._onScreenCtx.drawImage(this._maskCtx.canvas,0,0)}catch(l){}this.fireEvent("redraw")}},_update:function(){var a=this._useOffScreen,b=this._onScreenCtx.canvas,c;a?this._clearCanvas(this._offScreenCtx):this._clearCanvas(this._onScreenCtx);var d;for(c in this._layerOrder)d=this._layerOrder[c],(d=this._layers[d])&&d.isVisible()&&d._update();this._drawMask();
if(a){c=G.Browser.getCanvasRatio();a=b.width/(c[0]||1);b=b.height/(c[1]||1);try{this._clearCanvas(this._onScreenCtx),this._onScreenCtx.drawImage(this._offScreenCtx.canvas,0,0,a,b)}catch(f){}}try{this._onScreenCtx.drawImage(this._maskCtx.canvas,0,0)}catch(e){}this.fireEvent("update")},_drawMask:function(){var a=this._maskCtx,b=this.options,c,d=this._masks;if(d){var f=d.length;if(b.mask&&(this._clearCanvas(this._maskCtx),0!=f)){a.save();a.globalCompositeOperation="source-over";a.fillStyle=b.maskColor;
a.globalAlpha=b.maskOpacity;a.fillRect(0,0,a.canvas.width,a.canvas.height);a.globalCompositeOperation="destination-out";a.globalAlpha=1;for(b=0;b<f;b++)c=d[b],c._drawMask&&c._drawMask();a.restore()}}},_onResize:function(){this._resizeCanvases();this._updateDrawSize();this._requestUpdate()},_clearCanvas:function(a){a.clearRect(0,0,a.canvas.width,a.canvas.height)},_resizeCanvas:function(a,b,c,d){if(a&&b&&c){var f=a.canvas,e=d?d[0]||1:1;d=d?d[1]||1:1;var k=this.options.canvasExpandFactor,l=b*k,k=c*k;
b+=2*l;c+=2*k;G.DomUtil.setPosition(f,-l,-k);1==e&&1==d?(f.width=b,f.height=c,f.style.width="",f.style.height="",a.scale(1,1)):(f.width=b*e,f.height=c*d,f.style.width=b+"px",f.style.height=c+"px",a.scale(e,d))}},_resizeCanvases:function(){var a=this.getSize(),b=a[0],a=a[1],c=G.Browser.getCanvasRatio(),d=this.options.canvasExpandFactor;this._canvasOffset=[b*d,a*d];this._resizeCanvas(this._onScreenCtx,b,a,c);this._resizeCanvas(this._snapshotCtx,b,a,c);this._resizeCanvas(this._maskCtx,b,a,[1,1]);this._useOffScreen&&
this._resizeCanvas(this._offScreenCtx,b,a,c)},_onZoomStart:function(a){this._snapshotCanvas()},_onRotateStart:function(a){this._snapshotCanvas()},_onPinchStart:function(a){this._snapshotCanvas()},_snapshotCanvas:function(){if(!this.options.canvasAnimRedraw){var a=this._onScreenCtx.canvas,b=G.Browser.getCanvasRatio(),c=a.width/(b[0]||1),b=a.height/(b[1]||1);this._clearCanvas(this._snapshotCtx);this._snapshotCtx.drawImage(a,0,0,c,b)}},_calcCanvasOffset:function(){var a=this.getSize(),b=this.getDrawSize();
return[(a[0]-b[0])/2,(a[1]-b[1])/2]},_beforeMergeFramePos:function(){var a=G.DomUtil,b=a.getPosition(this._mapFrame),c=b[0],b=b[1],d=this._spark;if(d){var f=a.getPosition(d)||[0,0];a.markPosTransform(d,f[0]+c,f[1]+b);a.updateTransform(d)}try{this._onScreenCtx.drawImage(this._onScreenCtx.canvas,c,b)}catch(e){}}});
