...
(function () {
    ...
    BMapLib.TrafficControl = function () {
            // 默认停靠位置和偏移量
    ...
    TrafficControl.prototype._popUpDiv = function (me, btn) {
        ...
        this.show = function () {
            initialize();
            bShow = true;
            baidu.dom.removeClass(btn, "maplibTcBtnOff");
        }
        /**
         * 隐藏控制面板             * 
         * @return 无返回值
        ...
        this.hide = function () {
            bShow = false;
            baidu.dom.addClass(btn, "maplibTcBtnOff");
        ...
        //绑定事件，控制弹出层的显示跟隐藏
        baidu.event.on(btn, "onclick", function () {
           showOrHidePopDiv();
        });
        ...
        function initialize() {
            ...
            //获取本机时间。实时交通流量的显示，以此时间为标准。不考虑本机时间不对的情况。
            var t = new Date();
        ...
        function genHtml() {
            ...
            html.push('<div class="maplibTcTime"><span id="maplibTcDay" class="maplibTcCurTime">当前时间</span><span><span class="maplibTcColon">：&nbsp;</span><span class="maplibTcCurTime" id="tcNow"></span><span title="更新" id="tcUpdate" class="maplibTcUpdate"></span> <a href="javascript:void(0)" class="maplibTcView" id="tcViewPrediction">查看流量预测</a><button class="maplibTcClose" id="tcClose"></button></div></div>');
        ...
        function bindEventToPopDiv(me) {
            ...
            function showPrediction() {
                ...
                bRealTime = false;
                dvTcDay.innerHTML = "星期" + weekName[me.weekday];
                me.showTraffic();
            }
        ...
        function bindEventToWeek(me) {
            baidu.event.on("tcWeek", "onclick", function (e) {
                ...
                if (elem.tagName.toLowerCase() == "a") {
                    ...
                    me.weekday = (parseInt(attr(elem, "lang"), 10)) - 1;
                    updateTimeTxt();
                    me.showTraffic({
                        predictDate: {
                            hour: me.hour,
                            weekday: me.weekday + 1
                        }
                    });
                }
            });
        ...
        function setBar(me) {
            ...
            function setTimeBox() {
                ...
                me.hour = n;
                if (n < 10) n = "0" + n;
                dvTcTimeBox.innerHTML = dvTcNow.innerHTML = me.time = n + ":00";
            }
        }
    }
    /**
